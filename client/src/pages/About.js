    ...
    return (
        <div className="media">
            <div className="media-body">
                ...
                <br></br>
                <h3>Our hours of operation will change from day to day, please continue to check back frequently for our hours and what we will have available each day.</h3>
                <br></br>
                
                <h3>Please feel free to reach out to us if you have any questions; or stop by and pull some weeds.</h3>
                <p><img src="marlisringbell.jpg" className="pictureabout ml-3" alt="marlis ring bell">
                </img></p>
            </div>
